...
class ThemeBloc extends Bloc<ThemeEvent, ThemeState> {
  ThemeBloc(this._checkCurrentThemeUseCase, this._rememberThemeUseCase) : super(const ThemeState()) {
          ...
          switch(event) {
            ...
            case _ChangeThemeMode(darkMode: final darkMode):
              if(darkMode){
                ...
                await _rememberThemeUseCase.call(params: RememberThemeParam(ThemeMode.dark));
              }
              else{
                emit(state.copyWith(themeMode: ThemeMode.light));
                await _rememberThemeUseCase.call(params: RememberThemeParam(ThemeMode.light));
              }
              break;
          }
        } catch(e,s) {
